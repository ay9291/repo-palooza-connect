  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Furniture-specific variants
        premium: "bg-gradient-accent text-accent-foreground hover:opacity-90 shadow-medium font-semibold",
        wooden: "bg-wood-medium text-foreground hover:bg-wood-dark shadow-soft border border-wood-dark/20",
        cart: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-medium font-medium",
        hero: "bg-gradient-hero text-primary-foreground hover:opacity-90 shadow-strong text-base font-semibold",
      },
      size: {
